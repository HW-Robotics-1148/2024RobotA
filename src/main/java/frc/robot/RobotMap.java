...
public class RobotMap {
  ...
  public static class VisionConfig {
    ...
    public static final double DIFFERENCE_CUTOFF_THRESHOLD = 0.5; // Max difference between vision and odometry pose
                                                                  // estimate
    // Field limits
    ...
    public static final String POSE_LIMELIGHT = Constants.Swerve.shooterLimeLightID;
    public static final String NN_LIMELIGHT = Constants.Swerve.shooterLimeLightID;
    public static final int APRILTAG_PIPELINE = 1;
    public static final int NOTE_DETECTOR_PIPELINE = 2;

    public static final double POSE_LIME_X = -0.356; // Forward - Meters
    public static final double POSE_LIME_Y = 0; // Side - Right is positive on the limelight
    public static final double POSE_LIME_Z = 0.254; // Up
    ...
    public static final double POSE_LIME_YAW = 180.0;
